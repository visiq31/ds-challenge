...
*   **Logistics:** Median of **29 days** between consecutive orders for repeat customers.
*   **Customer Satisfaction:** Mean Review Score of **4.08**.
...
### Insight 1: The Loyalty Gap
With a **Repeat Purchase Rate of only 3.06%**, They are currently a "one-and-done" platform. 
